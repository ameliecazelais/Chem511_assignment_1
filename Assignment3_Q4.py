...
buzzer.value(1) # reverse logic, starts off silent

button = Pin(14, Pin.IN, Pin.PULL_UP) # kept the button to reset
last_state = 1
press_time = 0
...
while True:
    ...
    if reading >= 100:
        buzzer.value(1) # reverse logic for buzzer - buzzer if off
    else:
        buzzer.value(0)
